...
class ProxyMiddleare(object):
    ...
    def from_crawler(cls,crawler):
        return cls(
            proxyHost = crawler.settings.get('PROPXYHOST'),
            proxyPort = crawler.settings.get('PROPXYPORT'),
            proxyUser = crawler.settings.get('PROPXYUSER'),
            proxyPass = crawler.settings.get('PROPXYPASS')
        )
